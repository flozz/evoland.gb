...
inoremap <F12> :NERDTreeTabsTogglela
inoremap <C-Space> :call NERDComment('n', 'toggle')a
imap <S-PageDown> :bni
imap <S-PageUp> :bpi
imap <PageDown> <Nop>
imap <PageUp> <Nop>
vnoremap  "+ygv
nmap  :FufCoverageFile
vmap 	 >gv
nmap 	 >>
nnoremap  :nohlsearch
...
noremap  
noremap  u
noremap  :call NERDComment(0, "Toggle")
...
vmap  gc :GrammalecteClear
nmap  gc :GrammalecteClear
vmap  gg :GrammalecteCheck
nmap  gg :GrammalecteCheck
vmap  b :Babel vert
nmap  b :Babel vert
nnoremap  h :GundoToggle
nnoremap  ' viwc"pa'
nnoremap  " viwc"pa"
nnoremap  t :tabnew
vmap  a <Plug>(EasyAlign)<Right>
nnoremap  a vip<Plug>(EasyAlign)
...
nnoremap <F12> :NERDTreeTabsToggle
nnoremap <C-Space> :call NERDComment('n', 'toggle')
vnoremap <C-Space> :call NERDComment('x', 'toggle')gv
map <S-PageDown> :bn
map <S-PageUp> :bp
map <PageDown> <Nop>
map <PageUp> <Nop>
...
nmap <S-Tab> <<
vnoremap <BS> d
nnoremap <S-Left> :tabp
nnoremap <S-Right> :tabn
...
set guioptions=gimLt
set helplang=fr
set hlsearch
set incsearch
set laststatus=2
set listchars=nbsp:¬§,tab:‚ù≠‚îÄ,trail:‚Ä¢
set mouse=a
set mousemodel=popup_setpos
set printoptions=paper:a4
set ruler
set runtimepath=~/.vim,~/.vim/plugins/plugged/nerdtree/,~/.vim/plugins/plugged/nerdcommenter/,~/.vim/plugins/plugged/vim-airline/,~/.vim/plugins/plugged/vim-fugitive/,~/.vim/plugins/plugged/vim-gitgutter/,~/.vim/plugins/plugged/editorconfig-vim/,~/.vim/plugins/plugged/syntastic/,~/.vim/plugins/plugged/vim-easy-align/,~/.vim/plugins/plugged/vim-multiple-cursors/,~/.vim/plugins/plugged/vim-jsbeautify/,~/.vim/plugins/plugged/vim-surround/,~/.vim/plugins/plugged/vim-json/,~/.vim/plugins/plugged/yajs.vim/,~/.vim/plugins/plugged/javascript-libraries-syntax.vim/,~/.vim/plugins/plugged/vim-css3-syntax/,~/.vim/plugins/plugged/scss-syntax.vim/,~/.vim/plugins/plugged/html5.vim/,~/.vim/plugins/plugged/YouCompleteMe/,~/.vim/plugins/plugged/tern_for_vim/,~/.vim/plugins/plugged/vim-node/,~/.vim/plugins/plugged/vim-vimlint/,~/.vim/plugins/plugged/vim-vimlparser/,~/.vim/plugins/plugged/vim-signature/,~/.vim/plugins/plugged/vim-nerdtree-tabs/,~/.vim/plugins/plugged/gundo.vim/,~/.vim/plugins/plugged/gruvbox/,~/.vim/plugins/plugged/vim-fuzzyfinder/,~/.vim/plugins/plugged/L9/,~/.vim/plugins/plugged/nerdtree-git-plugin/,~/.vim/plugins/plugged/vim-babel/,~/.vim/plugins/plugged/webapi-vim/,~/.vim/plugins/plugged/vinarise.vim/,~/.vim/plugins/plugged/vim-pencil/,~/.vim/plugins/plugged/rust.vim/,~/.vim/plugins/plugged/vim-toml/,~/.vim/plugins/plugged/vim-css-color/,~/.vim/plugins/plugged/vim-jsdoc/,~/.vim/plugins/plugged/nginx.vim/,~/.vim/plugins/plugged/vim-table-mode/,~/.vim/plugins/plugged/vim-Grammalecte/,/var/lib/vim/addons,/usr/share/vim/vimfiles,/usr/share/vim/vim80,/usr/share/vim/vimfiles/after,/var/lib/vim/addons/after,~/.vim/plugins/plugged/javascript-libraries-syntax.vim/after,~/.vim/plugins/plugged/vim-css3-syntax/after,~/.vim/plugins/plugged/html5.vim/after,~/.vim/plugins/plugged/tern_for_vim/after,~/.vim/plugins/plugged/vim-signature/after,~/.vim/plugins/plugged/rust.vim/after,~/.vim/plugins/plugged/vim-css-color/after,~/.vim/after
set scrolloff=4
set shiftround
set shiftwidth=4
...
silent only
cd ~/devel/private/evolandgb/evolandgb
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +10 src/define.h
badd +23 src/main.c
badd +27 src/sprite16-anim.c
badd +0 src/sprite16-anim.h
badd +24 src/player.c
badd +0 src/player.h
badd +5 src/sprite16.c
badd +0 src/sprite16.h
badd +4 src/map.c
badd +0 src/map.h
argglobal
silent! argdel *
...
exe 'vert 1resize ' . ((&columns * 35 + 105) / 211)
exe 'vert 2resize ' . ((&columns * 131 + 105) / 211)
exe 'vert 3resize ' . ((&columns * 43 + 105) / 211)
argglobal
enew
file NERD_tree_1
let s:cpo_save=&cpo
...
lcd ~/devel/private/evolandgb/evolandgb
wincmd w
argglobal
setlocal keymap=
setlocal noarabic
...
wincmd w
argglobal
if bufexists('~/devel/private/evolandgb/evolandgb/src/define.h') | buffer ~/devel/private/evolandgb/evolandgb/src/define.h | else | edit ~/devel/private/evolandgb/evolandgb/src/define.h | endif
setlocal keymap=
setlocal noarabic
setlocal autoindent
setlocal backupcopy=
...
exe 'vert 2resize ' . ((&columns * 131 + 105) / 211)
exe 'vert 3resize ' . ((&columns * 43 + 105) / 211)
tabedit ~/devel/private/evolandgb/evolandgb/src/sprite16.c
set splitbelow splitright
wincmd _ | wincmd |
vsplit
wincmd _ | wincmd |
...
set winminheight=1 winheight=1 winminwidth=1 winwidth=1
exe 'vert 1resize ' . ((&columns * 35 + 105) / 211)
exe 'vert 2resize ' . ((&columns * 87 + 105) / 211)
exe 'vert 3resize ' . ((&columns * 87 + 105) / 211)
argglobal
enew
file ~/devel/private/evolandgb/evolandgb/NERD_tree_1
let s:cpo_save=&cpo
set cpo&vim
nnoremap <buffer> <silent> <NL> :call nerdtree#ui_glue#invokeKeyMap("<C-j>")
nnoremap <buffer> <silent>  :call nerdtree#ui_glue#invokeKeyMap("<C-k>")
...
wincmd w
argglobal
if bufexists('~/devel/private/evolandgb/evolandgb/src/sprite16.h') | buffer ~/devel/private/evolandgb/evolandgb/src/sprite16.h | else | edit ~/devel/private/evolandgb/evolandgb/src/sprite16.h | endif
setlocal keymap=
setlocal noarabic
setlocal autoindent
setlocal backupcopy=
...
exe 'vert 2resize ' . ((&columns * 87 + 105) / 211)
exe 'vert 3resize ' . ((&columns * 87 + 105) / 211)
tabedit ~/devel/private/evolandgb/evolandgb/src/sprite16-anim.c
set splitbelow splitright
wincmd _ | wincmd |
vsplit
wincmd _ | wincmd |
...
wincmd w
argglobal
if bufexists('~/devel/private/evolandgb/evolandgb/src/sprite16-anim.h') | buffer ~/devel/private/evolandgb/evolandgb/src/sprite16-anim.h | else | edit ~/devel/private/evolandgb/evolandgb/src/sprite16-anim.h | endif
setlocal keymap=
setlocal noarabic
setlocal autoindent
setlocal backupcopy=
...
exe 'vert 2resize ' . ((&columns * 87 + 105) / 211)
exe 'vert 3resize ' . ((&columns * 87 + 105) / 211)
tabedit ~/devel/private/evolandgb/evolandgb/src/player.c
set splitbelow splitright
wincmd _ | wincmd |
vsplit
wincmd _ | wincmd |
...
wincmd w
argglobal
if bufexists('~/devel/private/evolandgb/evolandgb/src/player.h') | buffer ~/devel/private/evolandgb/evolandgb/src/player.h | else | edit ~/devel/private/evolandgb/evolandgb/src/player.h | endif
setlocal keymap=
setlocal noarabic
setlocal autoindent
setlocal backupcopy=
...
exe 'vert 2resize ' . ((&columns * 87 + 105) / 211)
exe 'vert 3resize ' . ((&columns * 87 + 105) / 211)
tabedit ~/devel/private/evolandgb/evolandgb/src/map.c
set splitbelow splitright
wincmd _ | wincmd |
vsplit
wincmd _ | wincmd |
...
wincmd w
argglobal
if bufexists('~/devel/private/evolandgb/evolandgb/src/map.h') | buffer ~/devel/private/evolandgb/evolandgb/src/map.h | else | edit ~/devel/private/evolandgb/evolandgb/src/map.h | endif
setlocal keymap=
setlocal noarabic
setlocal autoindent
setlocal backupcopy=
